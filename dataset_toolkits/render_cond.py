...
from objaverse_modify import load_objects
# objaverse_modify.__version__

# # from objaverse_modify import xl
# uids = ['faef9fe5ace445e7b2989d1c1ece361c']
...
if __name__ == '__main__':
    ...
    file_path = objects[uids[0]]
    save_file_path = file_path[:file_path.rfind('/')]
    _render_cond(file_path, '1', save_file_path, opt.num_views)
